            ...
            <table className='profile__info-table'>
                <tbody>
                    <tr className='td--center'>
                        <td rowspan="2" className='td__fixed-width'><div className="profile__photo"><img src={avatar} alt="" /></div></td>
                    ...
                    <tr>
                        <td colspan="3" className='bold td--profile'><a href="#"><div className='td--flex'>Edit your profile<img className='map-arrow' src={arrow_icon} alt='' /></div></a></td>
                    </tr>
                    <tr>
